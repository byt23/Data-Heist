            ...
            VStack(spacing: 25) {
                ...
                VStack(spacing: 15) {
                    Button(action: {
                        ...
                        router.currentScreen = .game(level: playerStats.unlockedLevel) // ROUTER İLE GEÇİŞ
                    }) {
                        HStack {
                    ...
                    Button(action: {
                        HapticManager.shared.triggerImpact(style: .medium)
                        router.currentScreen = .map // ROUTER İLE GEÇİŞ
                    }) {
                        HStack {
                ...
                Text("© 2026 CYBERNETICS CORP.").font(.system(size: 10, design: .monospaced)).foregroundColor(.gray.opacity(0.4)).padding(.bottom, 10)
            }
        }
